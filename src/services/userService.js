...
export async function signUpUser(user) {
    ...
    try {
        const response = await axiosInstance.post('http://localhost:8080/api/users/signup', user); 
...
export async function SigninUser(user) {
    try {
        const response = await axiosInstance.post('http://localhost:8080/api/users/signin', user);
    ...
    export async function UpdateUser(user, id) {
        try {
            const response = await axiosInstance.put(`http://localhost:8080/api/users/updateUser/${id}`, user);
    ...
    export async function SignOutUser() {
        try {
            const response = await axiosInstance.post('http://localhost:8080/api/users/signout');
            console.log("The response from server",  response.data);
            return response.data;
        } catch (error) {
